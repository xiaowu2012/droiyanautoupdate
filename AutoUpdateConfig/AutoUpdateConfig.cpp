// AutoUpdateConfig.cpp : 定义应用程序的类行为。
//
...
BEGIN_MESSAGE_MAP(CAutoUpdateConfigApp, CWinApp)
	ON_COMMAND(ID_HELP, CWinApp::OnHelp)
END_MESSAGE_MAP()


// CAutoUpdateConfigApp 构造
...
// 唯一的一个 CAutoUpdateConfigApp 对象

CAutoUpdateConfigApp theApp;


// CAutoUpdateConfigApp 初始化
...
int CAutoUpdateConfigApp::ExitInstance()
{
	::CoUninitialize();
